...
const ThirdPage = ({ scrollEvent }: any) => {
  ...
  const holdScroll = () => {
    if (!scrollEvent.current) scrollEvent.current = true;
  };
  const releaseScroll = () => {
    if (scrollEvent.current) scrollEvent.current = false;
  };
    ...
    <div className="thirdPageLayout">
      ...
      <div className="contentContainer">
        <div className="contentRow">
          {myWorkList.map((x, i) => {
            return (
              <div key={x + "-" + i} className="contentCard">
                <img
                  className="cardImage"
                ...
                >
                  ...
                  <div className="link">
                    {x.git && (
                      <img
                        onClick={() => {
                          window.open(x.git, "_blank", "noopener, noreferrer");
                        }}
                        src={require("../../asset/gitIconWhite.png")}
                      />
                    )}
                    {x.notion && (
                      <img
                        ...
                        src={require("../../asset/notionIconWhite.png")}
                      />
                    )}
                    {x.link && (
                      <img
                        ...
                        src={require("../../asset/internetIconWhite.png")}
                      />
                    )}
                  </div>
                </div>
